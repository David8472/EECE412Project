...
public class RSA_encrypt {
    ...
    public static String encrypt(String plaintext, Key public_key) throws NoSuchAlgorithmException {
    ...
    public static byte[] sign_signature(Signature signature, String message, PrivateKey key)
    ...
    public static boolean verify_signature(Signature signature, String message, PublicKey key,
                                           byte[] signature_bytes) throws InvalidKeyException, SignatureException {
